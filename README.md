...
This application was a capstone project during my boot camp that I pair programmed with another student. I have kept the project with the same functionality that we delivered in roughly 24 hours of work. In my own hands I have refactored the project to be a closer representation of my coding signature. Below is the use case requirements laid out for the project when it was assigned. References to "Tenmo" are to the default
name chosen by my school for the project. 

In general the project was model after currency exchange platforms such as venmo, cashApp, etc...
...
1. **[Given to us as part of base program.]** As a user of the system, I need to be able to register myself with a username and password.
...
2. **[Given to us as part of base program.]** As a user of the system, I need to be able to log in using my registered username and password.
...
4. As an authenticated user of the system, I need to be able to *send* a transfer of a specific amount of money to a registered user.
   1. I should be able to choose from a list of users to send money to.
   ...
   6. I can't send more money than I have in my account.
...
7. As an authenticated user of the system, I need to be able to *request* a transfer of a specific amount of money from another registered user.
   1. I should be able to choose from a list of users to request money from.
...
9. As an authenticated user of the system, I need to be able to either approve or reject a Request Transfer.
   1. I can't "approve" a given Request Transfer for more money than I have in my account.
